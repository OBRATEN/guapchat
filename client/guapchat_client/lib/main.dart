...
class RegistrationPage extends StatefulWidget {
  ...
  @override
  _RegistrationPageState createState() => _RegistrationPageState(); // Исправлено здесь!
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      ...
                      final postResponse = await httpClient.post('api/register/', body: postData, headers: headers);
