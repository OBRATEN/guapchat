...
config :chatserver, ChatserverWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "yA8BBWRUARxN99F+nJjn2Uwadr6glUX7q9pXGeIrr4bMAKn9KZJENgqqd+ZVbCAO",
  watchers: [
...
config :chatserver, ChatserverWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/chatserver_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :chatserver, dev_routes: true
